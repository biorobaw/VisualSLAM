...
Current execution:
- Resumed via driver with `--resume-existing --skip-sim-worlds`.
- First pair currently running: `2014-05-14-13-46-12 -> 2014-05-14-13-46-12`.
- Logs directory: `SEQ_SLAM/reports/cross_model/seqslam_full_eval_2026-04-17_run1/oxford/logs`
...
6. Oxford stage resumed and is currently running.

## 8) Recovery / Resume Plan
## Current continuation mode
Run continuation is now using in-place resume on existing run label.
...
- Finish 3 Oxford tuning pairs.
- Build Oxford summary/report section in the run bundle.
- Write/update top-level bundle README.
...
3. Oxford section clearly states evo unavailable/skipped due to no GT (unless GT added later).
...
- Oxford tuning completion and final bundle README refresh.
